...
CREATE TABLE "PasswordResetToken" (
    ...
    "expires_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP + interval '15 minutes',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Checkout" ADD CONSTRAINT "Checkout_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
